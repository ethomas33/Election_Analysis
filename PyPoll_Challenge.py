...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_dict:
        ...
        county_results = f"{county_name}: {county_votes_percentage:,.1f}% ({county_votes:,})\n"
         # 6d: Print the county results to the terminal.
        print(county_results)
         # 6e: Save the county votes to a text file.
        txt_file.write(county_results)
         # 6f: Write an if statement to determine the winning county and get its vote count.
        if (county_votes > winning_county_count) and (county_votes_percentage > winning_county_percentage):
    ...
    winning_county_summary = (
        ...
        f"{winning_county} county\n"
        f"{winning_county_count:,} county total votes\n"
        f"{winning_county_percentage:.1f}% of total votes \n"
        f"-------------------------\n")
